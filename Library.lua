...
frame.Active = true
frame.Position = UDim2.new(defaultValues.PopupstartPos)
...
frame:TweenPosition(UDim2.new(defaultValues.PopupTween), Out, Quad, 1, false)
end
